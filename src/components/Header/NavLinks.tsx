...
const NavLinks = () => {
    return (
        <div className="flex gap-5 items-center z-10 sm:gap-1 mobile:fixed left-0 bottom-0 mobile:w-full mobile:justify-between mobile:bg-white mobile:h-[10vh] mobile:p-4">
            {
