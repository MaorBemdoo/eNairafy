...
const LogoSlider = () => {
    return (
        <div className="relative overflow-hidden whitespace-nowrap *:px-5 before:content-[''] before:absolute before:left-0 before:bg-gradient-to-l before:from-transparent before:to-white dark:before:to-black before:w-[100px] before:h-full before:z-10 after:content-[''] after:absolute after:right-0 after:bg-gradient-to-r after:from-transparent after:to-white dark:after:to-black after:w-[100px] after:h-full after:z-10">
